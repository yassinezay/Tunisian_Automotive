   ...
   
{
    if (
        ...
        $reservC->updatereserv($reserv,$_POST["idreserv"]);
  ...
  function showreserv($id)
    {
        if(require("../../db.php"))
        {
            ...
            $req = $db->prepare("SELECT * FROM reservation WHERE idreserv = ?");
           
            $req->execute(array($id));
            $reserv=$req->fetchAll(PDO ::FETCH_OBJ);
            return  $reserv;  
            $req->closeCursor();
        } 
        }
...
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <a href="afficherReserv.php"> <h4 class="card-title">retour à la liste</h4></a>
    ...
    if (isset($_POST['idreserv'])) {
        $list=showreserv($_POST['idreserv']);
...
<form action="" method="POST">
        <table border="3" align="center">
                <tr>
                    <td>
                        <label for="idreserv">Id reservation :
                        </label>
                    </td>
                    <td><input type="number" name="idreserv" id="idreserv" value="<?=  $list[0]->idreserv ?>"></td>
                </tr>
            ...
            <tr>
                ...
                <td><input type="date" name="date" id="date" value="<?= $list[0]->date ?>"></td>
            </tr>
            <tr>
                <td>
                    <label for="idvt">Id voiture:
                    </label>
                </td>
                <td><input type="number" name="idvt" id="idvt" value="<?=  $list[0]->idvt ?>"></td>
            </tr>
