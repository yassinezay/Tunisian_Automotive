...
$sql = 'SELECT COUNT(*) AS id_message FROM `message`;';
...
$nbArticles = (int) $result['id_message'];
...
$sql = 'SELECT * FROM `message` ORDER BY `id_message` DESC LIMIT :premier, :parpage;';
            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">List of messages</h4>
                    </div>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <a href="search.php"> <h4 class="card-title">Search for messages</h4></a>
                                <hr>
            ...
            <tr>
                ...
                <td align="center">
                    <form method="POST" action="updatemessage.php">
                        ...
                        <input type="hidden" value=<?PHP echo $message['id_message']; ?> name="id_message">
                    </form>
                </td>
                <td>
                    <a href="deletemessage.php?id_message=<?php echo $message['id_message']; ?>">Delete</a>
                </td>
            </tr>
            <?php
        }
         ...
         <nav>
                    <ul class="pagination">
                        ...
                        <li class="page-item <?= ($currentPage == 1) ? "disabled" : "" ?>">
                            <a href="listmessage.php?page=<?= $currentPage - 1 ?>" class="page-link">Précédente</a>
                        </li>
                        <?php for($page = 1; $page <= $pages; $page++): ?>
                          <!-- Lien vers chacune des pages (activé si on se trouve sur la page correspondante) -->
                          <li class="page-item <?= ($currentPage == $page) ? "active" : "" ?>">
                                <a href="listmessage.php?page=<?= $page ?>" class="page-link"><?= $page ?></a>
                            </li>
                        <?php endfor ?>
                          <!-- Lien vers la page suivante (désactivé si on se trouve sur la dernière page) -->
                          <li class="page-item <?= ($currentPage == $pages) ? "disabled" : "" ?>">
                            <a href="listmessage.php?page=<?= $currentPage + 1 ?>" class="page-link">Suivante</a>
                        </li>
                    </ul>
                </nav>
                        </div>
