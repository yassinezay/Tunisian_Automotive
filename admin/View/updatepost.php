        ...
        <div class="page-wrapper" style="min-height: 250px;">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="white-box">
                        <a href="listpost.php">   <h3 class="box-title">return to posts</h3></a>
<div id="error">
        <?php echo $error; ?>
    </div>
    ...
    if (isset($_POST['id_post'])) {
        $post = $postC->showpost($_POST['id_post']);
...
<form action="" method="POST">
        <table border="3" align="center">
                <tr>
                    <td>
                        <label for="id_post">Id post:
                        </label>
                    </td>
                    <td><input type="text" name="id_post" id="id_post" value="<?php echo $post['id_post']; ?>"></td>
                </tr>

            <tr>
                <td>
                    <label for="txt_post">texte post:
                    </label>
                </td>
                <td><input type="text" name="txt_post" id="txt_post" value="<?php echo $post['txt_post']; ?>"></td>
            </tr>
            <tr>
                    <td>
                    ...
                    <td>
                        <input type="text" name="id_admin" id="id_admin" value="<?php echo $post['id_admin']; ?>">
                    </td>
                </tr>
                <tr>
