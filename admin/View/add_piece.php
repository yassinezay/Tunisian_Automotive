...
if(isset($_POST['submit'])){
        $raouf = new raouf(null,$_POST['name'],$_POST['type'],$_POST['img'],$_POST['price'],$_POST['des']);
        $admincrudpanel->additem($raouf);
		echo('<script>alert("done");window.location = "liste_pieces.php";</script>');
}
?>  
            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Ajouter une pièce</h4>
                    </div>
                </div>
                <!-- /.col-lg-12 -->
            </div>
...
<script>
function verifili(){
	if(document.getElementById('name').value.length==0){document.getElementById('errowwr').innerHTML="Error Name !";return false;}
	//if(document.getElementById('type').value.length==0){document.getElementById('errowwr').innerHTML="Error type !";return false;}
	if(document.getElementById('img').value.length==0){document.getElementById('errowwr').innerHTML="Error img !";return false;}
	if(document.getElementById('price').value.length==0){document.getElementById('errowwr').innerHTML="Error price !";return false;}
	if(document.getElementById('des').value.length==0){document.getElementById('errowwr').innerHTML="Error des !";return false;}
	document.getElementById('eyyy').click();
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                        <div class="card-body">
                                <a href="liste_pieces.php"> <h4 class="card-title">return to list</h4></a>
                                <p id="errowwr" style="color:red;"></p>
        <div class="col-lg-12">
                    ...
                    <select class="form-control" name="type" id="type" >
						<option >Type</option>
						<option >Selon choix</option>
						<option >Standard</option>
                    </select>
                            </div> 
                            <div class="form-group">
                              <input class="form-control" placeholder="img" name="img" id="img">
                            </div> 
                            <div class="form-group">
                              <input class="form-control" placeholder="price" name="price" id="price">
                            </div>
                            <div class="form-group">
								<textarea class="form-control" placeholder="Description" name="des" id="des"></textarea>
                            </div>
							<input type="button" onclick="verifili();"  class="btn btn-default" value="Save">
                            <button type="submit" name="submit" id="eyyy" style="display:none;" class="btn btn-default">Save</button>
