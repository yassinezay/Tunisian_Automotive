...
if (
    ...
    isset($_POST["boite"])
        ...
        $commandeC->addVehicule($commande);
            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Add commandes</h4>
                    </div>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                        <div class="card-body">
                                <a href="liste_commandes.php"> <h4 class="card-title">return to list</h4></a>
                                <div id="error">
        <?php echo $error; ?>
    </div>
    <form action="" method="POST">
        <table border="1"  class="table table-bordered table-hover table-striped">
            ...
            <tr>
                ...
                <td><input type="text" name="boite" id="boite" ></td>
            </tr>
            <tr align="center">
                <td>
                    <input type="submit" value="Save" class="btn btn-xs btn-warning">
                </td>
                <td>
