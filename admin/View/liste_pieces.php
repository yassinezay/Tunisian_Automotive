...
$sql = 'SELECT COUNT(*) AS id FROM `articles`;';
...
?>
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <a href="add_piece.php"> <h4 class="card-title">Add ITEM</h4></a>
                                <hr>
            ...
            foreach ($list as $row) {
                                    ...
                                    echo '<td>'. $row['name'].'</td>';
                                    echo '<td>'. $row['type'].'</td>';
                                    echo '<td> <img src="../View/'. $row['img'].'" style="width:50px;"></td>';
                                    echo '<td>'. $row['price'].'</td>';
                                    echo '<td>'. $row['des'].'</td>';
                                    echo '<td>';
                                    echo ' <a  type="button" class="btn btn-xs btn-warning" href="edit.php?id='.$row['id'] . '"> EDIT </a> ';
                                    echo ' <a  type="button" class="btn btn-xs btn-danger" href="del.php?id=' . $row['id'] .'">DELETE </a> </td>';
                                    echo '</tr> ';
			}
            ...
            ?> 
                        ...
                        <li class="page-item <?= ($currentPage == 1) ? "disabled" : "" ?>">
                            <a href="liste_pieces.php?page=<?= $currentPage - 1 ?>" class="page-link">Précédente</a>
                        </li>
                        <?php for($page = 1; $page <= $pages; $page++): ?>
                          <!-- Lien vers chacune des pages (activé si on se trouve sur la page correspondante) -->
                          <li class="page-item <?= ($currentPage == $page) ? "active" : "" ?>">
                                <a href="liste_pieces.php?page=<?= $page ?>" class="page-link"><?= $page ?></a>
                            </li>
                        <?php endfor ?>
                          <!-- Lien vers la page suivante (désactivé si on se trouve sur la dernière page) -->
                          <li class="page-item <?= ($currentPage == $pages) ? "disabled" : "" ?>">
                            <a href="liste_pieces.php?page=<?= $currentPage + 1 ?>" class="page-link">Suivante</a>
                        </li>
                    </ul>
