...
<body>
            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Add to Panier</h4>
                    </div>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                        <div class="card-body">
                                <a href="panier_admin.php"> <h4 class="card-title">return to list</h4></a>
                                <div id="error">
        <?php echo $error; ?>
    </div>
    <form action="" method="POST">
        ...
        <tr>
            ...
            <tr>
                <td>
                    <label for="paid">ID_Commande:
                    </label>
                </td>
                <td><input type="number" name="id_commande" id="id_commande" ></td>
            </tr>
            <tr align="center">
                <td>
