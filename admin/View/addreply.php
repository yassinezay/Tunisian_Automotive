...
$reply = null;
$usersc=new ReplyC();
$list=$usersc->listclient();
$msg=new ReplyC();
$liste=$msg->listmessage();
            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Add reply to message</h4>
                    </div>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <a href="listreply.php"> <h4 class="card-title">return to reply messages</h4></a>
<section>
    ...
    <form action="" method="POST">
        <table border="3" align="center">
            ...
            <tr>
                ...
                <td><input type="text" name="texte_reply" id="texte_reply">
                <p style="color: red" id="textEr"></p></td>
            </tr>
            <tr>
                <td>
                ...
                <td><input type="date" name="date_reply" id="date_reply" ></td>
            </tr>
            <tr>
                <td>
                    <label for="heure_reply">heure reply:
                    </label>
                </td>
                <td>
                    <input type="time" name="heure_reply" id="heure_reply">
                </td>
            </tr>
            <tr>
                <td>
        ...
        ?>
        <option  value="<?= $client['id_user']; ?>"><?= $client['nom_user']; ?></option>
...
<?php
        ...
        ?>
            ...
            <tr>
                <td>
                    <label for="id_message">id_message:
                    </label>
                </td>
                <td>
        ...
        ?>
        <option  value="<?= $message['id_message']; ?>"><?= $message['texte_message']; ?></option>
