...
$sql = 'SELECT COUNT(*) AS id FROM `Vehicule`;';
...
$sql = 'SELECT * FROM `Vehicule` ORDER BY `idVehicule` DESC LIMIT :premier, :parpage;';
            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">List of Vehicules</h4>
                    </div>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <a href="add_Vehicule.php"> <h4 class="card-title">Add Vehicules</h4></a>
                                <hr>
                                        ...
                                        <tr>
                                            ...
                                            <td align="center">
                                                <form method="POST" action="update_vehicule.php">
                                                    ...
                                                    <input type="hidden" value=<?PHP echo $Vehicule['idVehicule']; ?> name="id">
                                                </form>
                                            </td>
                                            <td>
                                                <a href="delete_Vehicule.php?id=<?php echo $Vehicule['idVehicule']; ?>" class="btn btn-xs btn-danger">Delete</a>
                                            </td>
                                        </tr>
                                    <?php
                                    }
                    ...
                    <ul class="pagination">
                        ...
                        <li class="page-item <?= ($currentPage == 1) ? "disabled" : "" ?>">
                            <a href="liste_Vehicule.php?page=<?= $currentPage - 1 ?>" class="page-link">Précédente</a>
                        </li>
                        <?php for($page = 1; $page <= $pages; $page++): ?>
                          <!-- Lien vers chacune des pages (activé si on se trouve sur la page correspondante) -->
                          <li class="page-item <?= ($currentPage == $page) ? "active" : "" ?>">
                                <a href="liste_Vehicule.php?page=<?= $page ?>" class="page-link"><?= $page ?></a>
                            </li>
                        <?php endfor ?>
                          <!-- Lien vers la page suivante (désactivé si on se trouve sur la dernière page) -->
                          <li class="page-item <?= ($currentPage == $pages) ? "disabled" : "" ?>">
                            <a href="liste_Vehicule.php?page=<?= $currentPage + 1 ?>" class="page-link">Suivante</a>
                        </li>
                    </ul>
                </nav>
