...
$clientC->updateClient($client,$_POST["id_user"]);
        ...
        <div class="page-wrapper" style="min-height: 250px;">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="white-box">
                        <a href="admin.php">   <h3 class="box-title">return to list</h3></a>
<div id="error">
        <?php echo $error; ?>
    </div>
    ...
    if (isset($_POST['id_user'])) {
        $client = $clientC->showClient($_POST['id_user']);
...
<form action="" method="POST">
        <table border="3" align="center">
                <tr>
                    <td>
                        <label for="id_user">Id Client:
                        </label>
                    </td>
                    <td><input type="text" name="id_user" id="id_user" value="<?php echo $client['id_user']; ?>"></td>
                </tr>

            <tr>
                <td>
                    <label for="nom_user">First Name:
                    </label>
                </td>
                <td><input type="text" name="nom_user" id="nom_user" value="<?php echo $client['nom_user']; ?>"></td>
            </tr>
            <tr>
                <td>
                    <label for="prenom_user">Last Name:
                    </label>
                </td>
                <td><input type="text" name="prenom_user" id="prenom_user" value="<?php echo $client['prenom_user']; ?>" ></td>
            </tr>
            <tr>
                <td>
                    <label for="email_user">email_user:
                    </label>
                </td>
                <td>
                    <input type="text" name="email_user" id="email_user" value="<?php echo $client['email_user']; ?>">
                </td>
            </tr>
            <tr>
                    <td>
                        <label for="pw_user">Password:
                        </label>
                    </td>
                    <td>
                        <input type="password" name="pw_user" id="pw_user" value="<?php echo $client['pw_user']; ?>">
                    </td>
                </tr>
                <tr>
