...
$liste = $admincrudpanel->Oneitem($_GET['id']);
if(isset($_POST['submit'])){
        $raouf = new raouf($_POST['id'],$_POST['name'],$_POST['type'],$_POST['img'],$_POST['price'],$_POST['des']);
        $admincrudpanel->edititem($raouf, $_POST["id"]);
            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Update Commandes</h4>
                    </div>
                </div>
                <!-- /.col-lg-12 -->
            </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="white-box">
                            ...
                            <a href="liste_pieces.php">   <h3 class="box-title">return to list</h3></a>
<div id="error">
    </div>
    <?php 
                  ...
                  <h2>Edit Records</h2>
                      <div class="col-lg-6">
                        ...
                        <form role="form" method="post" action="">
                            ...
                            <div class="form-group">
                              <input class="form-control" placeholder="type" name="type" value="<?php echo($row['type']);?>">
                            </div> 
                            <div class="form-group">
                              <input class="form-control" placeholder="img" name="img" value="<?php echo($row['img']);?>">
                            </div> 
                            <div class="form-group">
                              <input class="form-control" placeholder="price" name="price" value="<?php echo($row['price']); ?>">
                            </div>
                            <div class="form-group">
								<textarea class="form-control" required placeholder="Description" name="des"><?php echo($row['des']); ?></textarea>
                            </div>
