...
$allures=$bdd->query('SELECT * FROM message ORDER BY id_message DESC');
if(isset($_GET['s']) AND !empty($_GET['s'])){
    $recherche = htmlspecialchars($_GET['s']);
    $allures=$bdd->query('SELECT texte_message From message where date_message like "%'.$recherche.'%" ORDER BY id_message DESC');
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="white-box">
                            <h3 class="box-title">Type date to see messages in this day</h3>
                            <hr>
                            <form method="GET">
        <input type="date" name="s" placeholder="rechercher un message" autocomplete="OFF">
...
while($message=$allures->fetch()){
    ...
    ?>
    <p> aucun message trouvé dans ce date</p>
<?php
}
