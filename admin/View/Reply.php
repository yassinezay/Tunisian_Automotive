...
$RRRRRRRRR = $admincrudpanel->ReplyCoder($id,$type);
if($RRRRRRRRR==1){
...
<div id="error">
    ...
    <?php 
	$liste = $admincrudpanel->Viewticket($id,$type);
                      ...
                      <div class="col-lg-6">
                        <form role="form" method="post" action="">
                            <div class="form-group">
                              <input disabled class="form-control" value="<?php echo($row["mail"]);?>">
                            </div>
                            <div class="form-group">
								<textarea class="form-control" required placeholder="Reply ..." name="des"></textarea>
                            </div>
