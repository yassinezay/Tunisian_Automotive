            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <a href="listmessage.php"> <h4 class="card-title">return to messages</h4></a>
<section>
    ...
    <form action="" method="POST">
        <table border="3" align="center">
            ...
            <tr>
                ...
                <td><input type="text" name="texte_message" id="texte_message" onkeyup="messagesValidation()">
            ...
            <tr>
                ...
                <td><input type="date" name="date_message" id="date_message" ></td>
            </tr>
            <tr>
                <td>
                    <label for="heure_message">heure message:
                    </label>
                </td>
                <td>
                    <input type="time" name="heure_message" id="heure_message">
                </td>
            </tr>
            <tr>
                <td>
