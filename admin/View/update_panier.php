...
if (
    ...
    isset($_POST["id_commande"])
        ...
        $panierC->updatepanier($panier, $_POST["id"]);
            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Update Panier</h4>
                    </div>
                </div>
                <!-- /.col-lg-12 -->
            </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="white-box">
                            ...
                            <a href="panier_admin.php">   <h3 class="box-title">return to list</h3></a>
<div id="error">
        <?php echo $error; ?>
    </div>
        <?php
    if (isset($_POST['id'])) {
        $panier = $panierC->showpanier($_POST['id']);
    ...
    <form action="" method="POST">
            ...
            <tr>
                    ...
                    <td><input type="text" name="id" id="id" value="<?php echo $panier['id']; ?>" ></td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td><input type="texte" name="quantite" id="quantite" value="<?php echo $panier['quantite']; ?>"></td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td><input type="number" name="id_produit" id="id_produit" value="<?php echo $panier['id_produit']; ?>" ></td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td><input type="number" name="id_commande" id="id_commande" value="<?php echo $panier['id_commande']; ?>" ></td>
                </tr>
                <tr>
