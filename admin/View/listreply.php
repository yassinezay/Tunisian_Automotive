...
$sql = 'SELECT COUNT(*) AS id_reply FROM `reply`;';
...
$nbArticles = (int) $result['id_reply'];
...
$sql = 'SELECT * FROM `reply` ORDER BY `id_reply` DESC LIMIT :premier, :parpage;';
...
<body>
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">List of reply</h4>
                    </div>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <a href="searchr.php"> <h4 class="card-title">Search for reply message</h4></a>
                                <hr>
        ...
        ?>
            <tr>
                <td><?= $reply['id_reply']; ?></td>
                <td><?= $reply['texte_reply']; ?></td>
                <td><?= $reply['date_reply']; ?></td>
                <td><?= $reply['heure_reply']; ?></td>
                <td><?= $reply['id_user']; ?></td>
                <td><?= $reply['id_message']; ?></td>
                <td align="center">
                    <form method="POST" action="updatereply.php">
                        <input type="submit" name="update" value="Update" class="btn">
                        <input type="hidden" value=<?PHP echo $reply['id_reply']; ?> name="id_reply">
                    </form>
                </td>
                <td>
                    <a href="deletereply.php?id_reply=<?php echo $reply['id_reply']; ?>">Delete</a>
                </td>
            </tr>
            <?php
        }
         ...
         <nav>
                    <ul class="pagination">
                        ...
                        <li class="page-item <?= ($currentPage == 1) ? "disabled" : "" ?>">
                            <a href="listreply.php?page=<?= $currentPage - 1 ?>" class="page-link">Précédente</a>
                        </li>
                        <?php for($page = 1; $page <= $pages; $page++): ?>
                          <!-- Lien vers chacune des pages (activé si on se trouve sur la page correspondante) -->
                          <li class="page-item <?= ($currentPage == $page) ? "active" : "" ?>">
                                <a href="listreply.php?page=<?= $page ?>" class="page-link"><?= $page ?></a>
                            </li>
                        <?php endfor ?>
                          <!-- Lien vers la page suivante (désactivé si on se trouve sur la dernière page) -->
                          <li class="page-item <?= ($currentPage == $pages) ? "disabled" : "" ?>">
                            <a href="listreply.php?page=<?= $currentPage + 1 ?>" class="page-link">Suivante</a>
                        </li>
                    </ul>
                </nav>
                        </div>
