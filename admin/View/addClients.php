            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <a href="admin.php"> <h4 class="card-title">return to list</h4></a>
<section>
    ...
    <form action="" method="POST">
        <table border="3" align="center">
            ...
            <tr>
                ...
                <td><input type="text" name="prenom_user" id="prenom_user" ></td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                <td>
                    <label for="pw_user">password_user:
                    </label>
                </td>
                <td>
                    <input type="password" name="pw_user" id="pw_user">
                </td>
            </tr>
            <tr align="center">
                <td>
