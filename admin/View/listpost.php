...
$sql = 'SELECT * FROM `post`,`admin` where admin.id_admin=post.id_admin ORDER BY `id_post` DESC LIMIT :premier, :parpage;';
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                            <a href="searchp.php"> <h4 class="card-title">Search for posts </h4></a>
                                <hr>
            ...
            <tr>
                ...
                <td align="center">
                    <form method="POST" action="updatepost.php">
                        ...
                        <input type="hidden" value=<?PHP echo $p['id_post']; ?> name="id_post">
                    </form>
                </td>
                <td>
                    <a href="deletepost.php?id_post=<?php echo $p['id_post']; ?>">Delete</a>
                </td>
            </tr>
            <?php
        }
         ...
         <nav>
                    <ul class="pagination">
                        ...
                        <li class="page-item <?= ($currentPage == 1) ? "disabled" : "" ?>">
                            <a href="listpost.php?page=<?= $currentPage - 1 ?>" class="page-link">Précédente</a>
                        </li>
                        <?php for($page = 1; $page <= $pages; $page++): ?>
                          <!-- Lien vers chacune des pages (activé si on se trouve sur la page correspondante) -->
                          <li class="page-item <?= ($currentPage == $page) ? "active" : "" ?>">
                                <a href="listpost.php?page=<?= $page ?>" class="page-link"><?= $page ?></a>
                            </li>
                        <?php endfor ?>
                          <!-- Lien vers la page suivante (désactivé si on se trouve sur la dernière page) -->
                          <li class="page-item <?= ($currentPage == $pages) ? "disabled" : "" ?>">
                            <a href="listpost.php?page=<?= $currentPage + 1 ?>" class="page-link">Suivante</a>
                        </li>
                    </ul>
                </nav>
                        </div>
