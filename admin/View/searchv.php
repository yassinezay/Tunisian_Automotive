<?php
require("../../db.php");
$allures=$db->query('SELECT * FROM voitures ORDER BY ID DESC');
if(isset($_GET['s']) AND !empty($_GET['s'])){
    $recherche = htmlspecialchars($_GET['s']);
    $allures=$db->query('SELECT * From voitures    where Marque  like "%'.$recherche.'%" ORDER BY ID DESC ');
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Search for cars</h4>
                    </div>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="white-box">
                            <h3 class="box-title">Taper la marque de la voiture</h3>
                            <hr>
                            <form method="GET">
        <input type="search" name="s" placeholder="rechercher une voiture" autocomplete="OFF">
