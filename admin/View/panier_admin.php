...
$sql = 'SELECT COUNT(*) AS id FROM `ligne_commande`;';
...
$sql = 'SELECT * FROM `ligne_commande` ORDER BY `id` DESC LIMIT :premier, :parpage;';
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <a href="add_panier.php"> <h4 class="card-title">Add to Panier</h4></a>
                                <hr>
            ...
            <th>Delete</th>
                ...
                <td align="center">
                    <form method="POST" action="update_panier.php">
                ...
                <td>
                    <a href="delete_panier.php?id=<?php echo $commande['id']; ?>" class="btn btn-xs btn-danger">Delete</a>
                </td>
            </tr>
                                    <?php
                                    }
                    ...
                    <ul class="pagination">
                        ...
                        <li class="page-item <?= ($currentPage == 1) ? "disabled" : "" ?>">
                            <a href="panier_admin.php?page=<?= $currentPage - 1 ?>" class="page-link">Précédente</a>
                        </li>
                        <?php for($page = 1; $page <= $pages; $page++): ?>
                          <!-- Lien vers chacune des pages (activé si on se trouve sur la page correspondante) -->
                          <li class="page-item <?= ($currentPage == $page) ? "active" : "" ?>">
                                <a href="panier_admin.php?page=<?= $page ?>" class="page-link"><?= $page ?></a>
                            </li>
                        <?php endfor ?>
                          <!-- Lien vers la page suivante (désactivé si on se trouve sur la dernière page) -->
                          <li class="page-item <?= ($currentPage == $pages) ? "disabled" : "" ?>">
                            <a href="panier_admin.php?page=<?= $currentPage + 1 ?>" class="page-link">Suivante</a>
                        </li>
                    </ul>
                </nav>
