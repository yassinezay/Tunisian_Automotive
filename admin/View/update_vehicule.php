...
if (
    ...
    isset($_POST["boite"])
        ...
        $VehiculeC->updateVehicule($Vehicule, $_POST["id"]);
            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Update Vehicules</h4>
                    </div>
                </div>
                <!-- /.col-lg-12 -->
            </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="white-box">
                            ...
                            <a href="liste_Vehicule.php">   <h3 class="box-title">return to list</h3></a>
<div id="error">
        <?php echo $error; ?>
    </div>
        <?php
    if (isset($_POST['id'])) {
        $Vehicule = $VehiculeC->showVehicule($_POST['id']);
    ...
    <form action="" method="POST">
            <table border="1" align="center" class="table table-bordered table-hover table-striped">
                <tr>
                    <td>
                        <label for="id">Id Vehicule:
                        </label>
                    </td>
                    <td><input type="text" name="id" id="id" value="<?php echo $Vehicule['idVehicule']; ?>" ></td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td><input type="texte" name="marque" id="marque" value="<?php echo $Vehicule['marque']; ?>"></td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td><input type="text" name="model" id="model" value="<?php echo $Vehicule['model']; ?>" ></td>
                </tr>
                <tr>
                    <td>
                        <label for="prix">Prix:
                    ...
                    <td><input type="number" name="prix" id="prix" value="<?php echo $Vehicule['prix']; ?>"></td>
                </tr>
                <tr>
                    <td>
                        <label for="boite">Boite:
                        </label>
                    </td>
                    <td><input type="texte" name="boite" id="boite" value="<?php echo $Vehicule['boite']; ?>"></td>
                </tr>
                <tr>
