...
$allures=$bdd->query('SELECT * FROM reply ORDER BY id_reply DESC');
if(isset($_GET['s']) AND !empty($_GET['s'])){
    $recherche = htmlspecialchars($_GET['s']);
    $allures=$bdd->query('SELECT texte_reply From reply where date_reply like "%'.$recherche.'%" ORDER BY id_reply DESC');
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Search for messages</h4>
                    </div>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="white-box">
                            <h3 class="box-title">Type date to see reply messages in this day</h3>
                            <hr>
                            <form method="GET">
        <input type="date" name="s" placeholder="rechercher un reply messages" autocomplete="OFF">
        <input type="submit" name="search" class="btn">
        <hr>
</form>
<section>
    <?php
if($allures->rowCount()>0){
while($reply=$allures->fetch()){
    ?>
    
    <p><?= $reply['texte_reply']; ?> </p>
    <?php
}
}else{
    ?>
    <p> aucun reply trouvé dans ce date</p>
<?php
}
