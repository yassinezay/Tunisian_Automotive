...
function messagesValidation() {
    let textInput = document.getElementById("texte_message");
...
let button1 = document.getElementsById("submitbtnn");
function postValidation() {
    let textInput = document.getElementById("txt_post");

    if (textInput.value.length < 10) {
        textError = " Le message doit compter au minimum 10 caractères.";
        document.getElementById("poster").innerHTML = textError;
        document.getElementById("submitbtnn").setAttribute("disabled", "true");
    ...
    document.getElementById("poster").innerHTML =
        "<p style='color:green'> Correct </p>";
        document.getElementById('submitbtnn').removeAttribute("disabled");
...
function nameValidation() {
  ...
  function lastnameValidation() {
    var letters = /^[A-Za-z]+$/;
    let lastname = document.getElementById("prenom_user");    
  ...
  function verifyPassword() {  
    var pw = document.getElementById("pw_user").value;  
