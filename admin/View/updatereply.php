...
if (
    ...
    isset($_POST["texte_reply"]) &&
    isset($_POST["date_reply"]) &&
    isset($_POST["heure_reply"]) &&
    isset($_POST["id_user"]) &&
...
)
{
    if (
        ...
        !empty($_POST['texte_reply']) &&
        !empty($_POST["date_reply"]) &&
        !empty($_POST["heure_reply"]) &&
        !empty($_POST["id_user"]) &&
...
$replyC->updatereply($reply,$_POST["id_reply"]);
        ...
        <div class="page-wrapper" style="min-height: 250px;">
            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Update of reply message</h4>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="white-box">
                        <a href="listreply.php">   <h3 class="box-title">return to reply messages list</h3></a>
<div id="error">
        <?php echo $error; ?>
    </div>
    ...
    if (isset($_POST['id_reply'])) {
        $reply = $replyC->showreply($_POST['id_reply']);
...
<form action="" method="POST">
        <table border="3" align="center">
                <tr>
                    <td>
                        <label for="id_reply">Id reply:
                        </label>
                    </td>
                    <td><input type="text" name="id_reply" id="id_reply" value="<?php echo $reply['id_reply']; ?>"></td>
                </tr>

            <tr>
                <td>
                    <label for="texte_reply">texte reply:
                    </label>
                </td>
                <td><input type="text" name="texte_reply" id="texte_reply" value="<?php echo $reply['texte_reply']; ?>"></td>
            </tr>
            <tr>
                <td>
                    <label for="date_reply">date reply:
                    </label>
                </td>
                <td><input type="date" name="date_reply" id="date_reply" value="<?php echo $reply['date_reply']; ?>" ></td>
            </tr>
            <tr>
                <td>
                    <label for="heure reply">heure reply:
                    </label>
                </td>
                <td>
                    <input type="time" name="heure_reply" id="heure_reply" value="<?php echo $reply['heure_reply']; ?>">
                </td>
            </tr>
            <tr>
                    <td>
                    ...
                    <td>
                        <input type="text" name="id_user" id="id_user" value="<?php echo $reply['id_user']; ?>">
                    </td>
                </tr>
                <tr>
                    <td>
                        <label for="id_message">id message:
                        </label>
                    </td>
                    <td>
                        <input type="text" name="id_message" id="id_message" value="<?php echo $reply['id_message']; ?>">
                    </td>
                </tr>
                <tr>
