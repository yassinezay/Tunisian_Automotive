...
$allures=$bdd->query('SELECT * FROM utilisateur ORDER BY id_user DESC');
if(isset($_GET['s']) AND !empty($_GET['s'])){
    $recherche = htmlspecialchars($_GET['s']);
    $allures=$bdd->query('SELECT nom_user From utilisateur where nom_user like "%'.$recherche.'%" ORDER BY id_user DESC');
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="white-box">
                            <h3 class="box-title">Type name client</h3>
                            <hr>
                            <form method="GET">
...
while($utilisateur=$allures->fetch()){
    ?>
    
    <p><?= $utilisateur['nom_user']; ?> </p>
    <?php
}
}else{
    ?>
