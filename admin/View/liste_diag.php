...
$sql = 'SELECT COUNT(*) AS id FROM `diagnostiques`;';
...
$sql = 'SELECT * FROM `diagnostiques` ORDER BY `id` DESC LIMIT :premier, :parpage;';
...
?>
        ...
        <div class="page-wrapper">
            ...
            foreach ($list as $row) {
                                    ...
                                    echo '<td>'. $row['tel'].'</td>';
                                    echo '<td>'. $row['mail'].'</td>';
                                    echo '<td>'. $row['addit'].'</td>';
                                    echo '<td>';
                                    if($row['seen']!='1'){
                                        echo ' <a  type="button" class="btn btn-xs btn-warning" href="Reply.php?id='.$row['id'].'&type=D"> Reply </a> ';
                                        echo ' <a  type="button" class="btn btn-xs btn-danger" href="Reject.php?id='.$row['id'].'&type=D"> Reject </a> </td>';
                                    }else{
                                        echo ' <a  type="button" class="btn btn-xs btn-danger" href="Reject.php?id='.$row['id'].'&type=D"> Delete </a> </td>';
                                    }
                                    echo '</tr> ';
			} 
            ...
            ?> 
                        ...
                        <li class="page-item <?= ($currentPage == 1) ? "disabled" : "" ?>">
                            <a href="liste_diag.php?page=<?= $currentPage - 1 ?>" class="page-link">Précédente</a>
                        </li>
                        <?php for($page = 1; $page <= $pages; $page++): ?>
                          <!-- Lien vers chacune des pages (activé si on se trouve sur la page correspondante) -->
                          <li class="page-item <?= ($currentPage == $page) ? "active" : "" ?>">
                                <a href="liste_diag.php?page=<?= $page ?>" class="page-link"><?= $page ?></a>
                            </li>
                        <?php endfor ?>
                          <!-- Lien vers la page suivante (désactivé si on se trouve sur la dernière page) -->
                          <li class="page-item <?= ($currentPage == $pages) ? "disabled" : "" ?>">
                            <a href="liste_diag.php?page=<?= $currentPage + 1 ?>" class="page-link">Suivante</a>
                        </li>
                    </ul>
