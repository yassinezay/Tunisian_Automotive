...
if (
    ...
    isset($_POST["id_user"])
        ...
        $commandeC->updatecommande($commande, $_POST["id"]);
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="white-box">
                            ...
                            <a href="liste_commandes.php">   <h3 class="box-title">return to list</h3></a>
<div id="error">
        <?php echo $error; ?>
    </div>
        <?php
    if (isset($_POST['id'])) {
        $commande = $commandeC->showcommande($_POST['id']);
    ...
    <form action="" method="POST">
            <table border="1" align="center" class="table table-bordered table-hover table-striped">
                <tr>
                    <td>
                        <label for="id">Id Commande:
                        </label>
                    </td>
                    <td><input type="text" name="id" id="id" value="<?php echo $commande['id']; ?>" ></td>
                </tr>
                <tr>
                    <td>
                        <label for="date_creation">Date de creation:
                        </label>
                    </td>
                    <td><input type="texte" name="date_creation" id="date_creation" value="<?php echo $commande['date_creation']; ?>"></td>
                </tr>
                <tr>
                    <td>
                        <label for="paid">Etat:
                    ...
                    <td><input type="number" name="paid" id="paid" value="<?php echo $commande['paid']; ?>" ></td>
                </tr>
                <tr>
                    <td>
                        <label for="date_creation">ID User:
                        </label>
                    </td>
                    <td><input type="texte" name="id_user" id="id_user" value="<?php echo $commande['id_user']; ?>"></td>
                </tr>
                <tr>
