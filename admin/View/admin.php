...
$sql = 'SELECT COUNT(*) AS id_user FROM `utilisateur`;';
...
$sql = 'SELECT * FROM `utilisateur` ORDER BY `id_user` DESC LIMIT :premier, :parpage;';
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <a href="searchu.php"> <h4 class="card-title">Search for clients</h4></a>
                                <hr>
        ...
        ?>
            <tr>
                ...
                <td><?= $client['pw_user']; ?></td>
                <td align="center">
                    <form method="POST" action="updateClient.php">
                        <input type="submit" name="update" value="Update" class="btn">
                        <input type="hidden" value=<?PHP echo $client['id_user']; ?> name="id_user">
                    </form>
                </td>
                <td>
                    <a href="deleteClient.php?id_user=<?php echo $client['id_user']; ?>">Delete</a>
                </td>
            </tr>
            <?php
        }
         ...
         <nav>
                    <ul class="pagination">
                        ...
                        <li class="page-item <?= ($currentPage == 1) ? "disabled" : "" ?>">
                            <a href="admin.php?page=<?= $currentPage - 1 ?>" class="page-link">Précédente</a>
                        </li>
                        ...
                        <?php endfor ?>
                          ...
                          <li class="page-item <?= ($currentPage == $pages) ? "disabled" : "" ?>">
                            <a href="admin.php?page=<?= $currentPage + 1 ?>" class="page-link">Suivante</a>
                        </li>
                    </ul>
                </nav>
                        </div>
