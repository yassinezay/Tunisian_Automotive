...
$allures=$bdd->query('SELECT * FROM post,admin where admin.id_admin=post.id_admin order by id_post');
if(isset($_GET['s']) AND !empty($_GET['s'])){
    $recherche = htmlspecialchars($_GET['s']);
    $allures=$bdd->query('SELECT * From post,admin where admin.nom_admin like "%'.$recherche.'%" ORDER BY id_post DESC');
}
?>
<!DOCTYPE html>
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Search for clients</h4>
                    </div>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="white-box">
                            <h3 class="box-title">Type name moderator to look for his posts</h3>
                            <hr>
                            <form method="GET">
        <input type="search" name="s" placeholder="rechercher un moderator" autocomplete="OFF">
