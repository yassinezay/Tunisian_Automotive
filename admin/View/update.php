...
)
{
    if (
        ...
        $voitureC->updateVoiture($voiture,$_POST["ID"]);
            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Modifier voiture</h4>
                    </div>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <a href="admin.php"> <h4 class="card-title">retour à la liste</h4></a>
...
<form action="" method="POST">
        <table border="3" align="center">
                <tr>
                    ...
                    <td><input type="number" name="ID" id="ID" value="<?=  $list[0]->ID ?>"></td>
                </tr>
            ...
            <tr>
                ...
                <td><input type="text" name="Marque" id="Marque" value="<?=  $list[0]->Marque ?>"></td>
            </tr>
            <tr>
                <td>
                ...
                <td><input type="text" name="Modele" id="Modele" value="<?=  $list[0]->Modele ?>"></td>
            </tr>
            <tr>
                <td>
                ...
                <td><input type="text" name="Matricule" id="Matricule" value="<?=  $list[0]->Matricule ?>"></td>
            </tr>
            <tr>
                <td>
                    <label for="Img">Image:
                ...
                <td><input type="text" name="Img" id="Img" value="<?=  $list[0]->Img ?>"></td>
            </tr>
            <tr>
                <td>
                ...
                <td><input type="number" name="PrixJour" id="PrixJour" value="<?=  $list[0]->PrixJour ?>"></td>
            </tr>
