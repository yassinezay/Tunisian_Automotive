...
if (
    ...
    isset($_POST["texte_message"]) &&
    isset($_POST["date_message"]) &&
    isset($_POST["heure_message"]) &&
    isset($_POST["id_user"])
...
)
{
    if (
        ...
        !empty($_POST['texte_message']) &&
        !empty($_POST["date_message"]) &&
        !empty($_POST["heure_message"]) &&
        !empty($_POST["id_user"]) 
    ) {
        $message = new Message(
            $_POST['id_message'],
            $_POST['texte_message'],
            new DateTime($_POST['date_message']),
            $_POST['heure_message'],
            $_POST['id_user']
...
$messageC->updatemessage($message,$_POST["id_message"]);
        ...
        <div class="page-wrapper" style="min-height: 250px;">
            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Update of client</h4>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="white-box">
                        <a href="listmessage.php">   <h3 class="box-title">return to messages</h3></a>
<div id="error">
        <?php echo $error; ?>
    </div>
    ...
    if (isset($_POST['id_message'])) {
        $message = $messageC->showmessage($_POST['id_message']);
...
<form action="" method="POST">
        <table border="3" align="center">
                <tr>
                    ...
                    <td><input type="text" name="id_message" id="id_message" value="<?php echo $message['id_message']; ?>"></td>
                </tr>

            <tr>
                <td>
                    <label for="texte_message">texte message:
                    </label>
                </td>
                <td><input type="text" name="texte_message" id="texte_message" value="<?php echo $message['texte_message']; ?>"></td>
            </tr>
            <tr>
                <td>
                    <label for="date_message">date message:
                    </label>
                </td>
                <td><input type="date" name="date_message" id="date_message" value="<?php echo $message['date_message']; ?>" ></td>
            </tr>
            <tr>
                <td>
                    <label for="heure message">heure message:
                    </label>
                </td>
                <td>
                    <input type="time" name="heure_message" id="heure_message" value="<?php echo $message['heure_message']; ?>">
                </td>
            </tr>
            <tr>
                    <td>
